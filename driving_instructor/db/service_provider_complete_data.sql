...
ALTER TABLE testimonial ADD CONSTRAINT `FK_testimonial` FOREIGN KEY (`service_provider_id`) REFERENCES `service_provider` (`id`);

ALTER TABLE special_offer ADD CONSTRAINT `FK_special_offer` FOREIGN KEY (`service_provider_id`) REFERENCES `service_provider` (`id`);

ALTER TABLE service_provider_tracking ADD CONSTRAINT `FK_service_provider_tracking` FOREIGN KEY (`service_provider_id`) REFERENCES `service_provider` (`id`);

ALTER TABLE service_provider_service_detail ADD CONSTRAINT `FK_service_provider_service_detail` FOREIGN KEY (`service_provider_id`) REFERENCES `service_provider` (`id`);

ALTER TABLE service_provider_other_details ADD CONSTRAINT `FK_service_provider_other_details` FOREIGN KEY (`service_provider_id`) REFERENCES `service_provider` (`id`);

ALTER TABLE service_provider ADD CONSTRAINT `FK_service_provider` FOREIGN KEY (`service_id`) REFERENCES `services` (`id`);

ALTER TABLE service_extra_info ADD CONSTRAINT `FK_service_extra_info` FOREIGN KEY (`service_provider_service_detail_id`) REFERENCES `service_provider_service_detail` (`id`);

ALTER TABLE service_area_tracking ADD CONSTRAINT `FK_service_area_tracking` FOREIGN KEY (`service_area_id`) REFERENCES `service_area` (`id`);

ALTER TABLE service_area_tracking ADD CONSTRAINT `FK_service_area_covered_sp` FOREIGN KEY (`service_area_id`) REFERENCES `service_area` (`id`);

ALTER TABLE service_area_tracking ADD CONSTRAINT `FK_service_area_covered_sa` FOREIGN KEY (`service_provider_id`) REFERENCES `service_provider` (`id`);

ALTER TABLE package_enrolled ADD CONSTRAINT `FK_package_enrolled_p` FOREIGN KEY (`package_id`) REFERENCES `package` (`id`);

ALTER TABLE package_enrolled ADD CONSTRAINT `FK_package_enrolled_sp` FOREIGN KEY (`service_provider_id`) REFERENCES `service_provider` (`id`);
 
ALTER TABLE address ADD CONSTRAINT  `FK_address` FOREIGN KEY (`service_provider_id`) REFERENCES `service_provider` (`id`);
