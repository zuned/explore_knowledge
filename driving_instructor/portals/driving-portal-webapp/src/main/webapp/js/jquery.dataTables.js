	...
	_oExt.oPagination = {
		...
		"full_numbers": {
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				var sList = '<div class="pagination pagination-mini pagination-right pull-right"><ul>';
				...
				for ( i=iStartButton ; i<=iEndButton ; i++ )
				{
					if ( iCurrentPage != i )
					{
						sList += '<li><a href="javascript://" class="'+oClasses.sPageButton+'">'+i+'</a></li>';
					}
					else
					{
						sList += '<li><a href="javascript://" class="'+oClasses.sPageButtonActive+'">'+i+'</a></li>';
					}
				}
